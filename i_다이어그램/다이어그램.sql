...
# : E-R 다이어그램 
# : Entity(존재하고 있는 것)등의 Relationship(관계)를 나타낸 Diagram(도표) 
# = 데이터들의 관계를 나타낸 도표(그림)
...
# : 일대일(1:1), 일대다(1:N), 다대댜(N:N)의 형태를 가질 수 있음 
# : 선으로 표현, 관계 이름과 유형이 선 위나 근처에 명시 
# : 관계를 나타내는 선은 연결된 엔티티들 사이를 이용 
...
# 1명의 학생에게서 0 ~ N개의 수강 내역이 존재할 수 있다.
